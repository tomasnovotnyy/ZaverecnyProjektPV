    ...
    public partial class Form9 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string encodedText = BinaryEncoding.Encode(inputText);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string encodedText = BinaryEncoding.Decode(inputText);
                encodedTextBox2.Text = encodedText;
                inputTextBox2.Clear();
            }
            catch (Exception ex)
            {
                MessageBox.Show("Nezadali jste platnou binární hodnotu!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                inputTextBox2.Clear();
            }
        }
